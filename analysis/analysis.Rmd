...
forest(mod_meta_results_h2_reactance$fitted_model)
...
- reactance (FALSE were excluded): `r mod_meta_results_h2_reactance$mod_meta_analysis_results_text`
...
### Sample sizes for moderation analyses
