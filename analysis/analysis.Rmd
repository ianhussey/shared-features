...
# anova
fit_exp_7_h1 <- aov(IAT_Score ~ Bag_Matching, 
                    contrasts = "contr.sum",
                    data = data_exp_7)

Anova(fit_exp_7_h1, type = "III")

# effect size
etaSquared(fit_exp_7_h1, type = 2, anova = FALSE )

# follow up t tests
pairwise.t.test(data_exp_7$IAT_Score, 
                data_exp_7$Bag_Matching, 
                p.adj = "holm")
...
data_exp_7 %>%
  ...
  dplyr::summarize(mean = mean(IAT_Score),
                   se = plotrix::std.error(IAT_Score)) %>%
  round_df(2)
...
# anova
fit_exp_7_h2 <- aov(EC_Effect_CS1_CS2_Difference_Score ~ Bag_Matching, 
                    contrasts = "contr.sum",
                    data = data_exp_7)

Anova(fit_exp_7_h2, type = "III")

# effect size
etaSquared(fit_exp_7_h2, type = 2, anova = FALSE )

# follow up t tests
pairwise.t.test(data_exp_7$EC_Effect_CS1_CS2_Difference_Score, 
                data_exp_7$Bag_Matching, 
                p.adj = "holm")
...
data_exp_7 %>%
  ...
  dplyr::summarize(mean = mean(EC_Effect_CS1_CS2_Difference_Score),
                   se = plotrix::std.error(EC_Effect_CS1_CS2_Difference_Score)) %>%
  round_df(2)
...
Meta analyses of experiments 1-8 (nb not 9, which contained no manipulations but acted as an extension of experiment 7).
...
results_exp_7nri_h1_us_contingency_memory <- data_exp_7nri %>%
  filter(US_contingency_memory == TRUE) %>%
  mutate(DV = IAT_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
results_exp_7ri_h1_us_contingency_memory <- data_exp_7ri %>%
  filter(US_contingency_memory == TRUE) %>%
  mutate(DV = IAT_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
results_for_meta_analysis_h1_us_contingency_memory <- 
  data.frame(Experiment = c("Experiment 1", "Experiment 2", "Experiment 3", 
             ...
             cohens_d = c(results_exp_1_h1_us_contingency_memory$cohens_d$estimate[[1]], 
                          ...
                          results_exp_7nri_h1_us_contingency_memory$cohens_d$estimate[[1]], 
                          results_exp_7ri_h1_us_contingency_memory$cohens_d$estimate[[1]]),
             ci_lwr = c(results_exp_1_h1_us_contingency_memory$cohens_d$conf.int[["lower"]],
                        ...
                        results_exp_7nri_h1_us_contingency_memory$cohens_d$conf.int[["lower"]],
                        results_exp_7ri_h1_us_contingency_memory$cohens_d$conf.int[["lower"]]),
             ci_upr = c(results_exp_1_h1_us_contingency_memory$cohens_d$conf.int[["upper"]],
                        ...
                        results_exp_7nri_h1_us_contingency_memory$cohens_d$conf.int[["upper"]],
                        results_exp_7ri_h1_us_contingency_memory$cohens_d$conf.int[["upper"]])) %>%
  mutate(yi = cohens_d, 
         sei = (ci_upr - ci_lwr)/(1.96*2)) %>%
...
## exp 7 standard instructions
results_exp_7nri_h2_us_contingency_memory <- data_exp_7nri %>%
  filter(US_contingency_memory == TRUE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
## exp 7 random instructions
results_exp_7ri_h2_us_contingency_memory <- data_exp_7ri %>%
  filter(US_contingency_memory == TRUE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
## exp 8
results_exp_8_h2_us_contingency_memory <- data_exp_8 %>%
  filter(US_contingency_memory == TRUE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)

results_exp_8_h2_color_valence_contingency_memory <- data_exp_8 %>%
  filter(color_valence_contingency_memory == TRUE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
results_for_meta_analysis_h2_us_contingency_memory <- 
  data.frame(Experiment = c("Experiment 1", "Experiment 2", "Experiment 3", 
             ...
             cohens_d = c(results_exp_1_h2_us_contingency_memory$cohens_d$estimate[[1]], 
                          ...
                          results_exp_7nri_h2_us_contingency_memory$cohens_d$estimate[[1]], 
                          results_exp_7ri_h2_us_contingency_memory$cohens_d$estimate[[1]],
                          results_exp_8_h2_us_contingency_memory$cohens_d$estimate[[1]]),
             ci_lwr = c(results_exp_1_h2_us_contingency_memory$cohens_d$conf.int[["lower"]],
                        ...
                        results_exp_7nri_h2_us_contingency_memory$cohens_d$conf.int[["lower"]],
                        results_exp_7ri_h2_us_contingency_memory$cohens_d$conf.int[["lower"]],
                        results_exp_8_h2_us_contingency_memory$cohens_d$conf.int[["lower"]]),
             ci_upr = c(results_exp_1_h2_us_contingency_memory$cohens_d$conf.int[["upper"]],
                        ...
                        results_exp_7nri_h2_us_contingency_memory$cohens_d$conf.int[["upper"]],
                        results_exp_7ri_h2_us_contingency_memory$cohens_d$conf.int[["upper"]],
                        results_exp_8_h2_us_contingency_memory$cohens_d$conf.int[["upper"]])) %>%
  mutate(yi = cohens_d, 
         sei = (ci_upr - ci_lwr)/(1.96*2)) %>%
  # remove exp 2 on the basis of the influence test 
  filter(Experiment != "Experiment 2")
...
results_for_meta_analysis_h2_color_valence_contingency_memory <- 
  data.frame(Experiment = c("Experiment 1", "Experiment 2", "Experiment 3", 
             ...
             cohens_d = c(results_exp_1_h2_color_valence_contingency_memory$cohens_d$estimate[[1]], 
                          ...
                          results_exp_8_h2_color_valence_contingency_memory$cohens_d$estimate[[1]]),
             ci_lwr = c(results_exp_1_h2_color_valence_contingency_memory$cohens_d$conf.int[["lower"]],
                        ...
                        results_exp_8_h2_color_valence_contingency_memory$cohens_d$conf.int[["lower"]]),
             ci_upr = c(results_exp_1_h2_color_valence_contingency_memory$cohens_d$conf.int[["upper"]],
                        ...
                        results_exp_8_h2_color_valence_contingency_memory$cohens_d$conf.int[["upper"]])) %>%
  mutate(yi = cohens_d, 
         sei = (ci_upr - ci_lwr)/(1.96*2)) %>%
  # remove exp 2 on the basis of the influence test 
  filter(Experiment != "Experiment 2")
...
# exp 8
results_exp_8_h3_us_contingency_memory <- data_exp_8 %>%
  filter(US_contingency_memory == TRUE) %>%
  mutate(DV = intention,
         IV = source_valence_condition) %>%
  multinominal_analysis()

results_exp_8_h3_color_valence_contingency_memory <- data_exp_8 %>%
  filter(color_valence_contingency_memory == TRUE) %>%
  mutate(DV = intention,
         IV = source_valence_condition) %>%
  multinominal_analysis()
...
results_for_meta_analysis_h3_us_contingency_memory <- 
  data.frame(Experiment = c("Experiment 1", "Experiment 2", "Experiment 3", "Experiment 4", 
             ...
             logOR = c(results_exp_1_h3_us_contingency_memory$logOR[results_exp_1_h3_us_contingency_memory$var == "Struan"], 
                       ...
                       results_exp_8_h3_us_contingency_memory$logOR[results_exp_8_h3_us_contingency_memory$var == "Struan"]),
             logOR_se = c(results_exp_1_h3_us_contingency_memory$logOR_se[results_exp_1_h3_us_contingency_memory$var == "Struan"],
                          ...
                          results_exp_8_h3_us_contingency_memory$logOR_se[results_exp_8_h3_us_contingency_memory$var == "Struan"])) %>%
  mutate(yi  = logOR,
         sei = logOR_se) %>%
  # remove exp 2 on the basis of the influence test 
  filter(Experiment != "Experiment 2")
...
results_for_meta_analysis_h3_color_valence_contingency_memory <- 
  data.frame(Experiment = c("Experiment 1", "Experiment 2", "Experiment 3", "Experiment 4", 
             ...
             logOR = c(results_exp_1_h3_color_valence_contingency_memory$logOR[results_exp_1_h3_color_valence_contingency_memory$var == "Struan"], 
                       ...
                       results_exp_8_h3_color_valence_contingency_memory$logOR[results_exp_8_h3_color_valence_contingency_memory$var == "Struan"]),
             logOR_se = c(results_exp_1_h3_color_valence_contingency_memory$logOR_se[results_exp_1_h3_color_valence_contingency_memory$var == "Struan"],
                          ...
                          results_exp_8_h3_color_valence_contingency_memory$logOR_se[results_exp_8_h3_color_valence_contingency_memory$var == "Struan"])) %>%
  mutate(yi  = logOR,
         sei = logOR_se) %>%
  # remove exp 2 on the basis of the influence test 
  filter(Experiment != "Experiment 2")
