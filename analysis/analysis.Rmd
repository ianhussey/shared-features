...
- add experiment 7 regular analysis
- exp 9 sig from zero tests
- exp 6 uses cs_US_contingency_memory instead of US_contingency_memory for iat, self report and intentions. standardize? other contingency memory variables also exist too across studies
...
Experiment 7 requires a one-way ANOVA instead of t-tests and the behavorial intentions test needs to be adjusted. Otherwise similar to the other studies.

- use bag-matching for analyses on whether randomness instructions matter, and the other comparison
- use source_valence_condition in the meta analysis for whehter the effect was shown. exclude bag matching condition 2, split up bag matching conditions 1 and 3 

### Standard non-random instructions condition for meta analysis

#### H1: IAT

```{r}

data_exp_7nri <- data_exp_7 %>%
  filter(Bag_Matching == "Shared_Feature_Bag_Location_Condition_1")

results_exp_7nri_h1 <- data_exp_7nri %>%
  mutate(DV = IAT_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
When CS1 eventually shared a color with positive words and CS2 shared a color with negative words, participants showed an automatic relative preference for CS1 over CS2 on the IAT (M = `r format(results_exp_7nri_h1$summary_stats$mean[results_exp_7nri_h1$summary_stats$IV == "CS1_Positive_CS2_Negative"], nsmall = 2)`, SD = `r format(results_exp_7nri_h1$summary_stats$sd[results_exp_7nri_h1$summary_stats$IV == "CS1_Positive_CS2_Negative"], nsmall = 2)`), whereas when CS1 eventually shared a color with negative words and CS2 shared a color with positive words, they demonstrated a relative preference for CS2 over CS1 (M = `r format(results_exp_7nri_h1$summary_stats$mean[results_exp_7nri_h1$summary_stats$IV == "CS2_Positive_CS1_Negative"], nsmall = 2)`, SD = `r format(results_exp_7nri_h1$summary_stats$sd[results_exp_7nri_h1$summary_stats$IV == "CS2_Positive_CS1_Negative"], nsmall = 2)`), `r results_exp_7nri_h1$t_test_output`, BF10 = `r format(results_exp_7nri_h1$bf10, nsmall = 2)`.

#### H2: Self-report ratings

```{r}

results_exp_7nri_h2 <- data_exp_7nri %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
When CS1 eventually shared a color with positive words and CS2 shared a color with negative words, participants showed a relative preference on the self-report ratings for CS1 over CS2 (M = `r format(results_exp_7nri_h2$summary_stats$mean[results_exp_7nri_h2$summary_stats$IV == "CS1_Positive_CS2_Negative"], nsmall = 2)`, SD = `r format(results_exp_7nri_h2$summary_stats$sd[results_exp_7nri_h2$summary_stats$IV == "CS1_Positive_CS2_Negative"], nsmall = 2)`), whereas when CS1 eventually shared a color with negative words and CS2 shared a color with positive words, they demonstrated a relative preference for CS2 over CS1 (M = `r format(results_exp_7nri_h2$summary_stats$mean[results_exp_7nri_h2$summary_stats$IV == "CS2_Positive_CS1_Negative"], nsmall = 2)`, SD = `r format(results_exp_7nri_h2$summary_stats$sd[results_exp_7nri_h2$summary_stats$IV == "CS2_Positive_CS1_Negative"], nsmall = 2)`), `r results_exp_7nri_h2$t_test_output`, BF10 = `r format(results_exp_7nri_h2$bf10, nsmall = 2)`.
...
When CS1 eventually shared a color with positive words and CS2 shared a color with negative words, participants showed an automatic relative preference for CS1 over CS2 on the IAT (M = `r format(results_exp_7ri_h1$summary_stats$mean[results_exp_7ri_h1$summary_stats$IV == "CS1_Positive_CS2_Negative"], nsmall = 2)`, SD = `r format(results_exp_7ri_h1$summary_stats$sd[results_exp_7ri_h1$summary_stats$IV == "CS1_Positive_CS2_Negative"], nsmall = 2)`), whereas when CS1 eventually shared a color with negative words and CS2 shared a color with positive words, they demonstrated a relative preference for CS2 over CS1 (M = `r format(results_exp_7ri_h1$summary_stats$mean[results_exp_7ri_h1$summary_stats$IV == "CS2_Positive_CS1_Negative"], nsmall = 2)`, SD = `r format(results_exp_7ri_h1$summary_stats$sd[results_exp_7ri_h1$summary_stats$IV == "CS2_Positive_CS1_Negative"], nsmall = 2)`), `r results_exp_7ri_h1$t_test_output`, BF10 = `r format(results_exp_7ri_h1$bf10, nsmall = 2)`.

#### H2: Self-report ratings

```{r}

results_exp_7ri_h2 <- data_exp_7ri %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
When CS1 eventually shared a color with positive words and CS2 shared a color with negative words, participants showed a relative preference on the self-report ratings for CS1 over CS2 (M = `r format(results_exp_7ri_h2$summary_stats$mean[results_exp_7ri_h2$summary_stats$IV == "CS1_Positive_CS2_Negative"], nsmall = 2)`, SD = `r format(results_exp_7ri_h2$summary_stats$sd[results_exp_7ri_h2$summary_stats$IV == "CS1_Positive_CS2_Negative"], nsmall = 2)`), whereas when CS1 eventually shared a color with negative words and CS2 shared a color with positive words, they demonstrated a relative preference for CS2 over CS1 (M = `r format(results_exp_7ri_h2$summary_stats$mean[results_exp_7ri_h2$summary_stats$IV == "CS2_Positive_CS1_Negative"], nsmall = 2)`, SD = `r format(results_exp_7ri_h2$summary_stats$sd[results_exp_7ri_h2$summary_stats$IV == "CS2_Positive_CS1_Negative"], nsmall = 2)`), `r results_exp_7ri_h2$t_test_output`, BF10 = `r format(results_exp_7ri_h2$bf10, nsmall = 2)`.
...
When CS1 eventually shared a color with positive words and CS2 shared a color with negative words, participants showed an automatic relative preference for CS1 over CS2 on the IAT (M = `r format(results_exp_8_h1$summary_stats$mean[results_exp_8_h1$summary_stats$IV == "CS1_Positive_CS2_Negative"], nsmall = 2)`, SD = `r format(results_exp_8_h1$summary_stats$sd[results_exp_8_h1$summary_stats$IV == "CS1_Positive_CS2_Negative"], nsmall = 2)`), whereas when CS1 eventually shared a color with negative words and CS2 shared a color with positive words, they demonstrated a relative preference for CS2 over CS1 (M = `r format(results_exp_8_h1$summary_stats$mean[results_exp_8_h1$summary_stats$IV == "CS2_Positive_CS1_Negative"], nsmall = 2)`, SD = `r format(results_exp_8_h1$summary_stats$sd[results_exp_8_h1$summary_stats$IV == "CS2_Positive_CS1_Negative"], nsmall = 2)`), `r results_exp_8_h1$t_test_output`, BF10 = `r format(results_exp_8_h1$bf10, nsmall = 2)`.

### H2: Self-report ratings

```{r}

results_exp_8_h2 <- data_exp_8 %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
When CS1 eventually shared a color with positive words and CS2 shared a color with negative words, participants showed a relative preference on the self-report ratings for CS1 over CS2 (M = `r format(results_exp_8_h2$summary_stats$mean[results_exp_8_h2$summary_stats$IV == "CS1_Positive_CS2_Negative"], nsmall = 2)`, SD = `r format(results_exp_8_h2$summary_stats$sd[results_exp_8_h2$summary_stats$IV == "CS1_Positive_CS2_Negative"], nsmall = 2)`), whereas when CS1 eventually shared a color with negative words and CS2 shared a color with positive words, they demonstrated a relative preference for CS2 over CS1 (M = `r format(results_exp_8_h2$summary_stats$mean[results_exp_8_h2$summary_stats$IV == "CS2_Positive_CS1_Negative"], nsmall = 2)`, SD = `r format(results_exp_8_h2$summary_stats$sd[results_exp_8_h2$summary_stats$IV == "CS2_Positive_CS1_Negative"], nsmall = 2)`), `r results_exp_8_h2$t_test_output`, BF10 = `r format(results_exp_8_h2$bf10, nsmall = 2)`.
...
# set reference level to "Morag"
data_exp_8$intention <- relevel(as.factor(data_exp_8$intention), ref = "Morag")

results_exp_8_h3 <- data_exp_8 %>%
  mutate(DV = intention,
         IV = source_valence_condition) %>%
  multinominal_analysis()
...
Data from the behavioural intentions question were entered into a multinomial logistic regression with CSI as the reference category. Only results from the CS1-CS2 comparison are relevant to the hypothesis and will be reported here. Results demonstrated that participants responses of CS1 relative to CS2 differed between the two conditions, congruent with training, OR = `r format(results_exp_8_h3$OR[results_exp_8_h3$var == "Struan"], nsmall = 2)`, 95% CI = [`r format(results_exp_8_h3$OR_ci_lwr[results_exp_8_h3$var == "Struan"], nsmall = 2)`, `r format(results_exp_8_h3$OR_ci_upr[results_exp_8_h3$var == "Struan"], nsmall = 2)`], p `r results_exp_8_h3$p[results_exp_8_h3$var == "Struan"]`.

## Experiment 9

### H1: IAT

XXXXXXXXXXX sig from zero tests needed
...
results_for_meta_analysis_h1 <- 
  data.frame(Experiment = c("Experiment 1", "Experiment 2", "Experiment 3", 
             ...
             cohens_d = c(results_exp_1_h1$cohens_d$estimate[[1]], 
                          ...
                          results_exp_7nri_h1$cohens_d$estimate[[1]], 
                          results_exp_7ri_h1$cohens_d$estimate[[1]]),
             ci_lwr = c(results_exp_1_h1$cohens_d$conf.int[["lower"]],
                        ...
                        results_exp_7nri_h1$cohens_d$conf.int[["lower"]],
                        results_exp_7ri_h1$cohens_d$conf.int[["lower"]]),
             ci_upr = c(results_exp_1_h1$cohens_d$conf.int[["upper"]],
                        ...
                        results_exp_7nri_h1$cohens_d$conf.int[["upper"]],
                        results_exp_7ri_h1$cohens_d$conf.int[["upper"]])) %>%
  mutate(yi = cohens_d, 
...
results_for_meta_analysis_h2 <- 
  data.frame(Experiment = c("Experiment 1", "Experiment 2", "Experiment 3", 
             ...
             cohens_d = c(results_exp_1_h2$cohens_d$estimate[[1]], 
                          ...
                          results_exp_7nri_h2$cohens_d$estimate[[1]],
                          results_exp_7ri_h2$cohens_d$estimate[[1]],
                          results_exp_8_h2$cohens_d$estimate[[1]]),
             ci_lwr = c(results_exp_1_h2$cohens_d$conf.int[["lower"]],
                        ...
                        results_exp_7nri_h2$cohens_d$conf.int[["lower"]],
                        results_exp_7ri_h2$cohens_d$conf.int[["lower"]],
                        results_exp_8_h2$cohens_d$conf.int[["lower"]]),
             ci_upr = c(results_exp_1_h2$cohens_d$conf.int[["upper"]],
                        ...
                        results_exp_7nri_h2$cohens_d$conf.int[["upper"]],
                        results_exp_7ri_h2$cohens_d$conf.int[["upper"]],
                        results_exp_8_h2$cohens_d$conf.int[["upper"]])) %>%
  mutate(yi = cohens_d, 
         sei = (ci_upr - ci_lwr)/(1.96*2))
...
results_for_meta_analysis_h3 <- 
  data.frame(Experiment = c("Experiment 1", "Experiment 2", "Experiment 3", "Experiment 4", 
                            "Experiment 5", "Experiment 6", "Experiment 8"),
             logOR = c(results_exp_1_h3$logOR[results_exp_1_h3$var == "Struan"], 
                       ...
                       results_exp_8_h3$logOR[results_exp_8_h3$var == "Struan"]),
             logOR_se = c(results_exp_1_h3$logOR_se[results_exp_1_h3$var == "Struan"],
                          ...
                          results_exp_8_h3$logOR_se[results_exp_8_h3$var == "Struan"])) %>%
  mutate(yi  = logOR,
         sei = logOR_se)
...
## exp 1
results_exp_1_h1_contingency_memory <- data_exp_1 %>%
...
## exp 2
results_exp_2_h1_contingency_memory <- data_exp_2 %>%
  filter(US_contingency_memory == TRUE) %>%
  mutate(DV = IAT_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
## exp 3
results_exp_3_h1_contingency_memory <- data_exp_3 %>%
  filter(US_contingency_memory == TRUE) %>%
  mutate(DV = IAT_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
## exp 4
results_exp_4_h1_contingency_memory <- data_exp_4 %>%
  filter(US_contingency_memory == TRUE) %>%
  mutate(DV = IAT_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
## exp 5
results_exp_5_h1_contingency_memory <- data_exp_5 %>%
  filter(US_contingency_memory == TRUE) %>%
  mutate(DV = IAT_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
## exp 6
results_exp_6_h1_contingency_memory <- data_exp_6 %>%
  filter(cs_US_contingency_memory == TRUE) %>%   # different variable than other studies
  mutate(DV = IAT_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
## exp 7 standard instructions
results_exp_7nri_h1_contingency_memory <- data_exp_7nri %>%
  filter(US_contingency_memory == TRUE) %>%
  mutate(DV = IAT_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)

results_exp_7nri_h1_demand_compliance <- data_exp_7nri %>%
  filter(demand_IAT == FALSE) %>%
  mutate(DV = IAT_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)

results_exp_7nri_h1_hypothesis_aware <- data_exp_7nri %>%
  filter(hypothesis_awareness == FALSE) %>%
  mutate(DV = IAT_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)

results_exp_7nri_h1_influence_aware <- data_exp_7nri %>%
  filter(influence_awareness == FALSE) %>%
  mutate(DV = IAT_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
## exp 7 random instructions
results_exp_7ri_h1_contingency_memory <- data_exp_7ri %>%
  filter(US_contingency_memory == TRUE) %>%
  mutate(DV = IAT_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)

results_exp_7ri_h1_demand_compliance <- data_exp_7ri %>%
  filter(demand_IAT == FALSE) %>%
  mutate(DV = IAT_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)

# results_exp_7ri_h1_hypothesis_aware <- data_exp_7ri %>%
#   filter(hypothesis_awareness == FALSE) %>%
#   mutate(DV = IAT_Score,
#          IV = source_valence_condition) %>%
#   t_test_analyses(.)
...
results_exp_7ri_h1_influence_aware <- data_exp_7ri %>%
  filter(influence_awareness == FALSE) %>%
  mutate(DV = IAT_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
results_for_meta_analysis_h1_contingency_memory <- 
  data.frame(Experiment = c("Experiment 1", "Experiment 2", "Experiment 3", 
             ...
             cohens_d = c(results_exp_1_h1_contingency_memory$cohens_d$estimate[[1]], 
                          ...
                          results_exp_6_h1_contingency_memory$cohens_d$estimate[[1]],
                          results_exp_7nri_h1_contingency_memory$cohens_d$estimate[[1]], 
                          results_exp_7ri_h1_contingency_memory$cohens_d$estimate[[1]]),
             ci_lwr = c(results_exp_1_h1_contingency_memory$cohens_d$conf.int[["lower"]],
                        results_exp_2_h1_contingency_memory$cohens_d$conf.int[["lower"]],
                        results_exp_3_h1_contingency_memory$cohens_d$conf.int[["lower"]],
                        results_exp_4_h1_contingency_memory$cohens_d$conf.int[["lower"]],
                        results_exp_5_h1_contingency_memory$cohens_d$conf.int[["lower"]],
                        results_exp_6_h1_contingency_memory$cohens_d$conf.int[["lower"]],
                        results_exp_7nri_h1_contingency_memory$cohens_d$conf.int[["lower"]],
                        results_exp_7ri_h1_contingency_memory$cohens_d$conf.int[["lower"]]),
             ci_upr = c(results_exp_1_h1_contingency_memory$cohens_d$conf.int[["upper"]],
                        results_exp_2_h1_contingency_memory$cohens_d$conf.int[["upper"]],
                        results_exp_3_h1_contingency_memory$cohens_d$conf.int[["upper"]],
                        results_exp_4_h1_contingency_memory$cohens_d$conf.int[["upper"]],
                        results_exp_5_h1_contingency_memory$cohens_d$conf.int[["upper"]],
                        results_exp_6_h1_contingency_memory$cohens_d$conf.int[["upper"]],
                        results_exp_7nri_h1_contingency_memory$cohens_d$conf.int[["upper"]],
                        results_exp_7ri_h1_contingency_memory$cohens_d$conf.int[["upper"]])) %>%
  mutate(yi = cohens_d, 
         sei = (ci_upr - ci_lwr)/(1.96*2)) %>%
...
results_for_meta_analysis_h1_demand_compliance <- 
  data.frame(Experiment = c("Experiment 1", "Experiment 2", "Experiment 3", 
             ...
             cohens_d = c(results_exp_1_h1_demand_compliance$cohens_d$estimate[[1]], 
                          ...
                          results_exp_7nri_h1_demand_compliance$cohens_d$estimate[[1]], 
                          results_exp_7ri_h1_demand_compliance$cohens_d$estimate[[1]]),
             ci_lwr = c(results_exp_1_h1_demand_compliance$cohens_d$conf.int[["lower"]],
                        ...
                        results_exp_7nri_h1_demand_compliance$cohens_d$conf.int[["lower"]],
                        results_exp_7ri_h1_demand_compliance$cohens_d$conf.int[["lower"]]),
             ci_upr = c(results_exp_1_h1_demand_compliance$cohens_d$conf.int[["upper"]],
                        ...
                        results_exp_7nri_h1_demand_compliance$cohens_d$conf.int[["upper"]],
                        results_exp_7ri_h1_demand_compliance$cohens_d$conf.int[["upper"]])) %>%
  mutate(yi = cohens_d, 
         sei = (ci_upr - ci_lwr)/(1.96*2)) %>%
  # remove exp 2 on the basis of the influence test 
  filter(Experiment != "Experiment 2")
...
results_for_meta_analysis_h1_hypothesis_aware <- 
  data.frame(Experiment = c("Experiment 1", "Experiment 2", "Experiment 3", 
                            "Experiment 4", "Experiment 5", "Experiment 6",
                            "Experiment 7 (standard)"), 
                            #"Experiment 7 (random)"), # not enough observations
             cohens_d = c(results_exp_1_h1_hypothesis_aware$cohens_d$estimate[[1]], 
                          ...
                          results_exp_7nri_h1_hypothesis_aware$cohens_d$estimate[[1]]), 
                          #results_exp_7ri_h1_hypothesis_aware$cohens_d$estimate[[1]]), # not enough observations
             ci_lwr = c(results_exp_1_h1_hypothesis_aware$cohens_d$conf.int[["lower"]],
                        ...
                        results_exp_7nri_h1_hypothesis_aware$cohens_d$conf.int[["lower"]]),
                        #results_exp_7ri_h1_hypothesis_aware$cohens_d$conf.int[["lower"]]), # not enough observations
             ci_upr = c(results_exp_1_h1_hypothesis_aware$cohens_d$conf.int[["upper"]],
                        ...
                        results_exp_7nri_h1_hypothesis_aware$cohens_d$conf.int[["upper"]])) %>% 
                        #results_exp_7ri_h1_hypothesis_aware$cohens_d$conf.int[["upper"]])) %>%  # not enough observations
  mutate(yi = cohens_d, 
         sei = (ci_upr - ci_lwr)/(1.96*2)) %>%
  # remove exp 2 on the basis of the influence test 
  filter(Experiment != "Experiment 2")
...
results_for_meta_analysis_h1_influence_aware <- 
  data.frame(Experiment = c("Experiment 1", "Experiment 2", "Experiment 3", 
             ...
             cohens_d = c(results_exp_1_h1_influence_aware$cohens_d$estimate[[1]], 
                          ...
                          results_exp_7nri_h1_influence_aware$cohens_d$estimate[[1]], 
                          results_exp_7ri_h1_influence_aware$cohens_d$estimate[[1]]),
             ci_lwr = c(results_exp_1_h1_influence_aware$cohens_d$conf.int[["lower"]],
                        ...
                        results_exp_7nri_h1_influence_aware$cohens_d$conf.int[["lower"]],
                        results_exp_7ri_h1_influence_aware$cohens_d$conf.int[["lower"]]),
             ci_upr = c(results_exp_1_h1_influence_aware$cohens_d$conf.int[["upper"]],
                        ...
                        results_exp_7nri_h1_influence_aware$cohens_d$conf.int[["upper"]],
                        results_exp_7ri_h1_influence_aware$cohens_d$conf.int[["upper"]])) %>%
  mutate(yi = cohens_d, 
         sei = (ci_upr - ci_lwr)/(1.96*2)) %>%
  # remove exp 2 on the basis of the influence test 
  filter(Experiment != "Experiment 2")
...
# robustness strings
robustness_contingency_memory_h1 <-
...
- Across studies, results `r robustness_contingency_memory_h1` robust to including only participants who were contingency aware, p in subsample `r meta_results_h1_contingency_memory$meta_analysis_results$estimate[meta_results_h1_contingency_memory$meta_analysis_results$metric == "p"]`.
...
# re run tests with desired subsets of participants
## exp 1
results_exp_1_h2_contingency_memory <- data_exp_1 %>%
  filter(US_contingency_memory == TRUE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
## exp 2
results_exp_2_h2_contingency_memory <- data_exp_2 %>%
  filter(US_contingency_memory == TRUE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
## exp 3
results_exp_3_h2_contingency_memory <- data_exp_3 %>%
  filter(US_contingency_memory == TRUE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
## exp 4
results_exp_4_h2_contingency_memory <- data_exp_4 %>%
  filter(US_contingency_memory == TRUE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
## exp 5
results_exp_5_h2_contingency_memory <- data_exp_5 %>%
  filter(US_contingency_memory == TRUE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
## exp 6
results_exp_6_h2_contingency_memory <- data_exp_6 %>%
  filter(cs_US_contingency_memory == TRUE) %>%   # different variable than other studies
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
## exp 7 standard instructions
results_exp_7nri_h2_contingency_memory <- data_exp_7nri %>%
  filter(US_contingency_memory == TRUE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)

results_exp_7nri_h2_demand_compliance <- data_exp_7nri %>%
  filter(demand_IAT == FALSE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)

results_exp_7nri_h2_hypothesis_aware <- data_exp_7nri %>%
  filter(hypothesis_awareness == FALSE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)

results_exp_7nri_h2_influence_aware <- data_exp_7nri %>%
  filter(influence_awareness == FALSE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
## exp 7 random instructions
results_exp_7ri_h2_contingency_memory <- data_exp_7ri %>%
  filter(US_contingency_memory == TRUE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)

results_exp_7ri_h2_demand_compliance <- data_exp_7ri %>%
  filter(demand_IAT == FALSE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)

# results_exp_7ri_h2_hypothesis_aware <- data_exp_7ri %>%
#   filter(hypothesis_awareness == FALSE) %>%
#   mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
#          IV = source_valence_condition) %>%
#   t_test_analyses(.)
...
results_exp_7ri_h2_influence_aware <- data_exp_7ri %>%
  filter(influence_awareness == FALSE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
## exp 8
results_exp_8_h2_contingency_memory <- data_exp_8 %>%
  filter(US_contingency_memory == TRUE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)

results_exp_8_h2_demand_compliance <- data_exp_8 %>%
  filter(demand_IAT == FALSE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)

results_exp_8_h2_hypothesis_aware <- data_exp_8 %>%
  filter(hypothesis_awareness == FALSE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)

results_exp_8_h2_influence_aware <- data_exp_8 %>%
  filter(influence_awareness == FALSE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
results_for_meta_analysis_h2_contingency_memory <- 
  data.frame(Experiment = c("Experiment 1", "Experiment 2", "Experiment 3", 
             ...
             cohens_d = c(results_exp_1_h2_contingency_memory$cohens_d$estimate[[1]], 
                          ...
                          results_exp_6_h2_contingency_memory$cohens_d$estimate[[1]],
                          results_exp_7nri_h2_contingency_memory$cohens_d$estimate[[1]], 
                          results_exp_7ri_h2_contingency_memory$cohens_d$estimate[[1]],
                          results_exp_8_h2_contingency_memory$cohens_d$estimate[[1]]),
             ci_lwr = c(results_exp_1_h2_contingency_memory$cohens_d$conf.int[["lower"]],
                        results_exp_2_h2_contingency_memory$cohens_d$conf.int[["lower"]],
                        results_exp_3_h2_contingency_memory$cohens_d$conf.int[["lower"]],
                        results_exp_4_h2_contingency_memory$cohens_d$conf.int[["lower"]],
                        results_exp_5_h2_contingency_memory$cohens_d$conf.int[["lower"]],
                        results_exp_6_h2_contingency_memory$cohens_d$conf.int[["lower"]],
                        results_exp_7nri_h2_contingency_memory$cohens_d$conf.int[["lower"]],
                        results_exp_7ri_h2_contingency_memory$cohens_d$conf.int[["lower"]],
                        results_exp_8_h2_contingency_memory$cohens_d$conf.int[["lower"]]),
             ci_upr = c(results_exp_1_h2_contingency_memory$cohens_d$conf.int[["upper"]],
                        results_exp_2_h2_contingency_memory$cohens_d$conf.int[["upper"]],
                        results_exp_3_h2_contingency_memory$cohens_d$conf.int[["upper"]],
                        results_exp_4_h2_contingency_memory$cohens_d$conf.int[["upper"]],
                        results_exp_5_h2_contingency_memory$cohens_d$conf.int[["upper"]],
                        results_exp_6_h2_contingency_memory$cohens_d$conf.int[["upper"]],
                        results_exp_7nri_h2_contingency_memory$cohens_d$conf.int[["upper"]],
                        results_exp_7ri_h2_contingency_memory$cohens_d$conf.int[["upper"]],
                        results_exp_8_h2_contingency_memory$cohens_d$conf.int[["upper"]])) %>%
  mutate(yi = cohens_d, 
         sei = (ci_upr - ci_lwr)/(1.96*2)) %>%
  # remove exp 2 on the basis of the influence test 
  filter(Experiment != "Experiment 2")
...
results_for_meta_analysis_h2_demand_compliance <- 
  data.frame(Experiment = c("Experiment 1", "Experiment 2", "Experiment 3", 
             ...
             cohens_d = c(results_exp_1_h2_demand_compliance$cohens_d$estimate[[1]], 
                          ...
                          results_exp_7nri_h2_demand_compliance$cohens_d$estimate[[1]], 
                          results_exp_7ri_h2_demand_compliance$cohens_d$estimate[[1]],
                          results_exp_8_h2_demand_compliance$cohens_d$estimate[[1]]),
             ci_lwr = c(results_exp_1_h2_demand_compliance$cohens_d$conf.int[["lower"]],
                        ...
                        results_exp_7nri_h2_demand_compliance$cohens_d$conf.int[["lower"]],
                        results_exp_7ri_h2_demand_compliance$cohens_d$conf.int[["lower"]],
                        results_exp_8_h2_demand_compliance$cohens_d$conf.int[["lower"]]),
             ci_upr = c(results_exp_1_h2_demand_compliance$cohens_d$conf.int[["upper"]],
                        ...
                        results_exp_7nri_h2_demand_compliance$cohens_d$conf.int[["upper"]],
                        results_exp_7ri_h2_demand_compliance$cohens_d$conf.int[["upper"]],
                        results_exp_8_h2_demand_compliance$cohens_d$conf.int[["upper"]])) %>%
  mutate(yi = cohens_d, 
         sei = (ci_upr - ci_lwr)/(1.96*2)) %>%
  # remove exp 2 on the basis of the influence test 
  filter(Experiment != "Experiment 2")
...
results_for_meta_analysis_h2_hypothesis_aware <- 
  data.frame(Experiment = c("Experiment 1", "Experiment 2", "Experiment 3", 
             ...
             cohens_d = c(results_exp_1_h2_hypothesis_aware$cohens_d$estimate[[1]], 
                          ...
                          results_exp_7nri_h2_hypothesis_aware$cohens_d$estimate[[1]], 
                          #results_exp_7ri_h2_hypothesis_aware$cohens_d$estimate[[1]]), # not enough observations
                          results_exp_8_h2_hypothesis_aware$cohens_d$estimate[[1]]),
             ci_lwr = c(results_exp_1_h2_hypothesis_aware$cohens_d$conf.int[["lower"]],
                        ...
                        results_exp_7nri_h2_hypothesis_aware$cohens_d$conf.int[["lower"]],
                        #results_exp_7ri_h2_hypothesis_aware$cohens_d$conf.int[["lower"]]), # not enough observations
                        results_exp_8_h2_hypothesis_aware$cohens_d$conf.int[["lower"]]),
             ci_upr = c(results_exp_1_h2_hypothesis_aware$cohens_d$conf.int[["upper"]],
                        ...
                        results_exp_7nri_h2_hypothesis_aware$cohens_d$conf.int[["upper"]], 
                        #results_exp_7ri_h2_hypothesis_aware$cohens_d$conf.int[["upper"]])
                        results_exp_8_h2_hypothesis_aware$cohens_d$conf.int[["upper"]])) %>%  # not enough observations
  mutate(yi = cohens_d, 
         sei = (ci_upr - ci_lwr)/(1.96*2)) %>%
  # remove exp 2 on the basis of the influence test 
  filter(Experiment != "Experiment 2")
...
results_for_meta_analysis_h2_influence_aware <- 
  data.frame(Experiment = c("Experiment 1", "Experiment 2", "Experiment 3", 
             ...
             cohens_d = c(results_exp_1_h2_influence_aware$cohens_d$estimate[[1]], 
                          ...
                          results_exp_7nri_h2_influence_aware$cohens_d$estimate[[1]], 
                          results_exp_7ri_h2_influence_aware$cohens_d$estimate[[1]],
                          results_exp_8_h2_influence_aware$cohens_d$estimate[[1]]),
             ci_lwr = c(results_exp_1_h2_influence_aware$cohens_d$conf.int[["lower"]],
                        ...
                        results_exp_7nri_h2_influence_aware$cohens_d$conf.int[["lower"]],
                        results_exp_7ri_h2_influence_aware$cohens_d$conf.int[["lower"]],
                        results_exp_8_h2_influence_aware$cohens_d$conf.int[["lower"]]),
             ci_upr = c(results_exp_1_h2_influence_aware$cohens_d$conf.int[["upper"]],
                        ...
                        results_exp_7nri_h2_influence_aware$cohens_d$conf.int[["upper"]],
                        results_exp_7ri_h2_influence_aware$cohens_d$conf.int[["upper"]],
                        results_exp_8_h2_influence_aware$cohens_d$conf.int[["upper"]])) %>%
  mutate(yi = cohens_d, 
         sei = (ci_upr - ci_lwr)/(1.96*2)) %>%
  # remove exp 2 on the basis of the influence test 
  filter(Experiment != "Experiment 2")
...
# robustness strings
robustness_contingency_memory_h2 <-
...
- Across studies, results `r robustness_contingency_memory_h2` robust to including only participants who were contingency aware, p in subsample `r meta_results_h2_contingency_memory$meta_analysis_results$estimate[meta_results_h2_contingency_memory$meta_analysis_results$metric == "p"]`.
...
# re run tests with desired subsets of participants
# exp 1
results_exp_1_h3_contingency_memory <- data_exp_1 %>%
  filter(US_contingency_memory == TRUE) %>%
  mutate(DV = intention,
         IV = source_valence_condition) %>%
  multinominal_analysis()
...
# exp 2
results_exp_2_h3_contingency_memory <- data_exp_2 %>%
  filter(US_contingency_memory == TRUE) %>%
  mutate(DV = intention,
         IV = source_valence_condition) %>%
  multinominal_analysis()
...
# exp 3
results_exp_3_h3_contingency_memory <- data_exp_3 %>%
  filter(US_contingency_memory == TRUE) %>%
  mutate(DV = intention,
         IV = source_valence_condition) %>%
  multinominal_analysis()
...
# exp 4
results_exp_4_h3_contingency_memory <- data_exp_4 %>%
  filter(US_contingency_memory == TRUE) %>%
  mutate(DV = intention,
         IV = source_valence_condition) %>%
  multinominal_analysis()
...
# exp 5
results_exp_5_h3_contingency_memory <- data_exp_5 %>%
  filter(US_contingency_memory == TRUE) %>%
  mutate(DV = intention,
         IV = source_valence_condition) %>%
  multinominal_analysis()
...
# exp 6
results_exp_6_h3_contingency_memory <- data_exp_6 %>%
  filter(cs_US_contingency_memory == TRUE) %>%  # different to the other studies
  mutate(DV = intention,
         IV = source_valence_condition) %>%
  multinominal_analysis()
...
# exp 8
results_exp_8_h3_contingency_memory <- data_exp_8 %>%
  filter(US_contingency_memory == TRUE) %>%
  mutate(DV = intention,
         IV = source_valence_condition) %>%
  multinominal_analysis()

results_exp_8_h3_hypothesis_aware <- data_exp_8 %>%
  filter(hypothesis_awareness == FALSE) %>%
  mutate(DV = intention,
         IV = source_valence_condition) %>%
  multinominal_analysis()

results_exp_8_h3_influence_aware <- data_exp_8 %>%
  filter(influence_awareness == FALSE) %>%
  mutate(DV = intention,
         IV = source_valence_condition) %>%
  multinominal_analysis()
...
results_for_meta_analysis_h3_contingency_memory <- 
  data.frame(Experiment = c("Experiment 1", "Experiment 2", "Experiment 3", "Experiment 4", 
             ...
             logOR = c(results_exp_1_h3_contingency_memory$logOR[results_exp_1_h3_contingency_memory$var == "Struan"], 
                       ...
                       results_exp_6_h3_contingency_memory$logOR[results_exp_6_h3_contingency_memory$var == "Struan"],
                       results_exp_8_h3_contingency_memory$logOR[results_exp_8_h3_contingency_memory$var == "Struan"]),
             logOR_se = c(results_exp_1_h3_contingency_memory$logOR_se[results_exp_1_h3_contingency_memory$var == "Struan"],
                          ...
                          results_exp_6_h3_contingency_memory$logOR_se[results_exp_6_h3_contingency_memory$var == "Struan"],
                          results_exp_8_h3_contingency_memory$logOR_se[results_exp_8_h3_contingency_memory$var == "Struan"])) %>%
  mutate(yi  = logOR,
         sei = logOR_se) %>%
  # remove exp 2 on the basis of the influence test 
  filter(Experiment != "Experiment 2")
...
results_for_meta_analysis_h3_hypothesis_aware <- 
  data.frame(Experiment = c("Experiment 1", "Experiment 2", "Experiment 3", "Experiment 4", 
             ...
             logOR = c(results_exp_1_h3_hypothesis_aware$logOR[results_exp_1_h3_hypothesis_aware$var == "Struan"], 
                       ...
                       results_exp_8_h3_hypothesis_aware$logOR[results_exp_8_h3_hypothesis_aware$var == "Struan"]),
             logOR_se = c(results_exp_1_h3_hypothesis_aware$logOR_se[results_exp_1_h3_hypothesis_aware$var == "Struan"],
                          ...
                          results_exp_8_h3_hypothesis_aware$logOR_se[results_exp_8_h3_hypothesis_aware$var == "Struan"])) %>%
  mutate(yi  = logOR,
         sei = logOR_se) %>%
  # remove exp 2 on the basis of the influence test 
  filter(Experiment != "Experiment 2")
...
results_for_meta_analysis_h3_influence_aware <- 
  data.frame(Experiment = c("Experiment 1", "Experiment 2", "Experiment 3", "Experiment 4", 
             ...
             logOR = c(results_exp_1_h3_influence_aware$logOR[results_exp_1_h3_influence_aware$var == "Struan"], 
                       ...
                       results_exp_8_h3_influence_aware$logOR[results_exp_8_h3_influence_aware$var == "Struan"]),
             logOR_se = c(results_exp_1_h3_influence_aware$logOR_se[results_exp_1_h3_influence_aware$var == "Struan"],
                          ...
                          results_exp_8_h3_influence_aware$logOR_se[results_exp_8_h3_influence_aware$var == "Struan"])) %>%
  mutate(yi  = logOR,
         sei = logOR_se) %>%
  # remove exp 2 on the basis of the influence test 
  filter(Experiment != "Experiment 2")
...
# robustness strings
robustness_contingency_memory_h3 <-
...
- Across studies, results `r robustness_contingency_memory_h3` robust to including only participants who were contingency aware, p in subsample `r meta_results_h3_contingency_memory$meta_analysis_results$estimate[meta_results_h3_contingency_memory$meta_analysis_results$metric == "p"]`.
