...
data_combined <- 
  ...
  select(experiment, US_contingency_memory, color_valence_contingency_memory, 
         demand_IAT, demand_self_reports, hypothesis_awareness, influence_awareness) %>%
...
temp_4_by_exp <- data_combined %>%
  count(experiment, influence_awareness) %>%
  spread(influence_awareness, n) %>%
  mutate(NOT_influence_awareness = `FALSE` / (`TRUE` + `FALSE`)) %>%
  select(experiment, NOT_influence_awareness)
...
temp_1_by_exp %>%
  ...
  left_join(temp_4_by_exp, by = "experiment") %>%
...
results_exp_1_h1_influence_aware_excluded <- data_exp_1 %>%
  filter(influence_awareness == TRUE) %>%
  mutate(DV = IAT_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
results_exp_2_h1_influence_aware_excluded <- data_exp_2 %>%
  filter(influence_awareness == TRUE) %>%
  mutate(DV = IAT_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
results_exp_3_h1_influence_aware_excluded <- data_exp_3 %>%
  filter(influence_awareness == TRUE) %>%
  mutate(DV = IAT_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
results_exp_4_h1_influence_aware_excluded <- data_exp_4 %>%
  filter(influence_awareness == TRUE) %>%
  mutate(DV = IAT_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
results_exp_5_h1_influence_aware_excluded <- data_exp_5 %>%
  filter(influence_awareness == TRUE) %>%
  mutate(DV = IAT_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
results_exp_6_h1_influence_aware_excluded <- data_exp_6 %>%
  filter(influence_awareness == TRUE) %>%
  mutate(DV = IAT_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
results_exp_8nri_h1_influence_aware_excluded <- data_exp_8nri %>%
  filter(influence_awareness == TRUE) %>%
  mutate(DV = IAT_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
results_exp_8ri_h1_influence_aware_excluded <- data_exp_8ri %>%
  filter(influence_awareness == TRUE) %>%
  mutate(DV = IAT_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
# influence_aware
results_for_meta_analysis_h1_influence_aware_excluded <- 
  data.frame(Experiment = c("Experiment 1", "Experiment 2", "Experiment 3", 
                            "Experiment 4", "Experiment 5", "Experiment 6",
                            "Experiment 8 (standard)", 
                            "Experiment 8 (random)"), 
             cohens_d = c(results_exp_1_h1_influence_aware_excluded$cohens_d$estimate[[1]], 
                          results_exp_2_h1_influence_aware_excluded$cohens_d$estimate[[1]], 
                          results_exp_3_h1_influence_aware_excluded$cohens_d$estimate[[1]], 
                          results_exp_4_h1_influence_aware_excluded$cohens_d$estimate[[1]],
                          results_exp_5_h1_influence_aware_excluded$cohens_d$estimate[[1]],
                          results_exp_6_h1_influence_aware_excluded$cohens_d$estimate[[1]],
                          results_exp_8nri_h1_influence_aware_excluded$cohens_d$estimate[[1]], 
                          results_exp_8ri_h1_influence_aware_excluded$cohens_d$estimate[[1]]),
             ci_lwr = c(results_exp_1_h1_influence_aware_excluded$cohens_d$conf.int[["lower"]],
                        results_exp_2_h1_influence_aware_excluded$cohens_d$conf.int[["lower"]],
                        results_exp_3_h1_influence_aware_excluded$cohens_d$conf.int[["lower"]],
                        results_exp_4_h1_influence_aware_excluded$cohens_d$conf.int[["lower"]],
                        results_exp_5_h1_influence_aware_excluded$cohens_d$conf.int[["lower"]],
                        results_exp_6_h1_influence_aware_excluded$cohens_d$conf.int[["lower"]],
                        results_exp_8nri_h1_influence_aware_excluded$cohens_d$conf.int[["lower"]],
                        results_exp_8ri_h1_influence_aware_excluded$cohens_d$conf.int[["lower"]]),
             ci_upr = c(results_exp_1_h1_influence_aware_excluded$cohens_d$conf.int[["upper"]],
                        results_exp_2_h1_influence_aware_excluded$cohens_d$conf.int[["upper"]],
                        results_exp_3_h1_influence_aware_excluded$cohens_d$conf.int[["upper"]],
                        results_exp_4_h1_influence_aware_excluded$cohens_d$conf.int[["upper"]],
                        results_exp_5_h1_influence_aware_excluded$cohens_d$conf.int[["upper"]],
                        results_exp_6_h1_influence_aware_excluded$cohens_d$conf.int[["upper"]],
                        results_exp_8nri_h1_influence_aware_excluded$cohens_d$conf.int[["upper"]],
                        results_exp_8ri_h1_influence_aware_excluded$cohens_d$conf.int[["upper"]])) %>%
  mutate(yi = cohens_d, 
         sei = (ci_upr - ci_lwr)/(1.96*2)) %>%
  # remove exp 2 on the basis of the influence test 
  filter(Experiment != "Experiment 2") %>%
...
mod_meta_results_h1_influence_aware <- 
  moderator_meta_analysis_workflow(data = bind_rows(semi_join(mutate(results_for_meta_analysis_h1_influence_aware, exclude = FALSE),
                                                              results_for_meta_analysis_h1_influence_aware_excluded,
                                                              by = "Experiment"),
                                                    results_for_meta_analysis_h1_influence_aware_excluded),
                                   effect_size_label = "Cohen's d")
...
forest(mod_meta_results_h1_hypothesis_aware$fitted_model)
forest(mod_meta_results_h1_influence_aware$fitted_model)
...
- hypothesis awareness (FALSE were excluded): `r mod_meta_results_h1_hypothesis_aware$mod_meta_analysis_results_text`
- influence awareness (FALSE were excluded): `r mod_meta_results_h1_influence_aware$mod_meta_analysis_results_text`
...
results_exp_1_h2_influence_aware_excluded <- data_exp_1 %>%
  filter(influence_awareness == TRUE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
results_exp_2_h2_influence_aware_excluded <- data_exp_2 %>%
  filter(influence_awareness == TRUE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
results_exp_3_h2_influence_aware_excluded <- data_exp_3 %>%
  filter(influence_awareness == TRUE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
results_exp_4_h2_influence_aware_excluded <- data_exp_4 %>%
  filter(influence_awareness == TRUE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
results_exp_5_h2_influence_aware_excluded <- data_exp_5 %>%
  filter(influence_awareness == TRUE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
results_exp_6_h2_influence_aware_excluded <- data_exp_6 %>%
  filter(influence_awareness == TRUE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
results_exp_7_h2_influence_aware_excluded <- data_exp_7 %>%
  filter(influence_awareness == TRUE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
results_exp_8nri_h2_influence_aware_excluded <- data_exp_8nri %>%
  filter(influence_awareness == TRUE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
results_exp_8ri_h2_influence_aware_excluded <- data_exp_8ri %>%
  filter(influence_awareness == TRUE) %>%
  mutate(DV = EC_Effect_CS1_CS2_Difference_Score,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
...
# influence_aware
results_for_meta_analysis_h2_influence_aware_excluded <- 
  data.frame(Experiment = c("Experiment 1", "Experiment 2", "Experiment 3", 
                            "Experiment 4", "Experiment 5", "Experiment 6",
                            "Experiment 7",
                            "Experiment 8 (standard)", 
                            "Experiment 8 (random)"), 
             cohens_d = c(results_exp_1_h2_influence_aware_excluded$cohens_d$estimate[[1]], 
                          results_exp_2_h2_influence_aware_excluded$cohens_d$estimate[[1]], 
                          results_exp_3_h2_influence_aware_excluded$cohens_d$estimate[[1]], 
                          results_exp_4_h2_influence_aware_excluded$cohens_d$estimate[[1]],
                          results_exp_5_h2_influence_aware_excluded$cohens_d$estimate[[1]],
                          results_exp_6_h2_influence_aware_excluded$cohens_d$estimate[[1]],
                          results_exp_7_h2_influence_aware_excluded$cohens_d$estimate[[1]],
                          results_exp_8nri_h2_influence_aware_excluded$cohens_d$estimate[[1]], 
                          results_exp_8ri_h2_influence_aware_excluded$cohens_d$estimate[[1]]),
             ci_lwr = c(results_exp_1_h2_influence_aware_excluded$cohens_d$conf.int[["lower"]],
                        results_exp_2_h2_influence_aware_excluded$cohens_d$conf.int[["lower"]],
                        results_exp_3_h2_influence_aware_excluded$cohens_d$conf.int[["lower"]],
                        results_exp_4_h2_influence_aware_excluded$cohens_d$conf.int[["lower"]],
                        results_exp_5_h2_influence_aware_excluded$cohens_d$conf.int[["lower"]],
                        results_exp_6_h2_influence_aware_excluded$cohens_d$conf.int[["lower"]],
                        results_exp_7_h2_influence_aware_excluded$cohens_d$conf.int[["lower"]],
                        results_exp_8nri_h2_influence_aware_excluded$cohens_d$conf.int[["lower"]],
                        results_exp_8ri_h2_influence_aware_excluded$cohens_d$conf.int[["lower"]]),
             ci_upr = c(results_exp_1_h2_influence_aware_excluded$cohens_d$conf.int[["upper"]],
                        results_exp_2_h2_influence_aware_excluded$cohens_d$conf.int[["upper"]],
                        results_exp_3_h2_influence_aware_excluded$cohens_d$conf.int[["upper"]],
                        results_exp_4_h2_influence_aware_excluded$cohens_d$conf.int[["upper"]],
                        results_exp_5_h2_influence_aware_excluded$cohens_d$conf.int[["upper"]],
                        results_exp_6_h2_influence_aware_excluded$cohens_d$conf.int[["upper"]],
                        results_exp_7_h2_influence_aware_excluded$cohens_d$conf.int[["upper"]],
                        results_exp_8nri_h2_influence_aware_excluded$cohens_d$conf.int[["upper"]],
                        results_exp_8ri_h2_influence_aware_excluded$cohens_d$conf.int[["upper"]])) %>%
  mutate(yi = cohens_d, 
         sei = (ci_upr - ci_lwr)/(1.96*2)) %>%
  # remove exp 2 on the basis of the influence test 
  filter(Experiment != "Experiment 2") %>%
...
mod_meta_results_h2_influence_aware <- 
  moderator_meta_analysis_workflow(data = bind_rows(semi_join(mutate(results_for_meta_analysis_h2_influence_aware, exclude = FALSE),
                                                              results_for_meta_analysis_h2_influence_aware_excluded,
                                                              by = "Experiment"),
                                                    results_for_meta_analysis_h2_influence_aware_excluded), 
                                   effect_size_label = "Cohen's d")
...
forest(mod_meta_results_h2_hypothesis_aware$fitted_model)
forest(mod_meta_results_h2_influence_aware$fitted_model)
...
- hypothesis awareness (FALSE were excluded): `r mod_meta_results_h2_hypothesis_aware$mod_meta_analysis_results_text`
- influence awareness (FALSE were excluded): `r mod_meta_results_h2_influence_aware$mod_meta_analysis_results_text`
...
results_exp_1_h3_influence_aware_excluded <- data_exp_1 %>%
  filter(influence_awareness == TRUE) %>%
  mutate(DV = intention,
         IV = source_valence_condition) %>%
  multinominal_analysis()
...
results_exp_2_h3_influence_aware_excluded <- data_exp_2 %>%
  filter(influence_awareness == TRUE) %>%
  mutate(DV = intention,
         IV = source_valence_condition) %>%
  multinominal_analysis()
...
results_exp_3_h3_influence_aware_excluded <- data_exp_3 %>%
  filter(influence_awareness == TRUE) %>%
  mutate(DV = intention,
         IV = source_valence_condition) %>%
  multinominal_analysis()
...
results_exp_4_h3_influence_aware_excluded <- data_exp_4 %>%
  filter(influence_awareness == TRUE) %>%
  mutate(DV = intention,
         IV = source_valence_condition) %>%
  multinominal_analysis()
...
results_exp_5_h3_influence_aware_excluded <- data_exp_5 %>%
  filter(influence_awareness == TRUE) %>%
  mutate(DV = intention,
         IV = source_valence_condition) %>%
  multinominal_analysis()
...
results_exp_6_h3_influence_aware_excluded <- data_exp_6 %>%
  filter(influence_awareness == TRUE) %>%
  mutate(DV = intention,
         IV = source_valence_condition) %>%
  multinominal_analysis()
...
results_exp_7_h3_influence_aware_excluded <- data_exp_7 %>%
  filter(influence_awareness == TRUE) %>%
  mutate(DV = intention,
         IV = source_valence_condition) %>%
  multinominal_analysis()
...
# influence aware
results_for_meta_analysis_h3_influence_aware_excluded <- 
  data.frame(Experiment = c("Experiment 1", "Experiment 2", "Experiment 3", "Experiment 4", 
                            "Experiment 5", "Experiment 6", "Experiment 7"),
             logOR = c(results_exp_1_h3_influence_aware_excluded$logOR[results_exp_1_h3_influence_aware_excluded$var == "Struan"], 
                       results_exp_2_h3_influence_aware_excluded$logOR[results_exp_2_h3_influence_aware_excluded$var == "Struan"],
                       results_exp_3_h3_influence_aware_excluded$logOR[results_exp_3_h3_influence_aware_excluded$var == "Struan"],
                       results_exp_4_h3_influence_aware_excluded$logOR[results_exp_4_h3_influence_aware_excluded$var == "Struan"],
                       results_exp_5_h3_influence_aware_excluded$logOR[results_exp_5_h3_influence_aware_excluded$var == "Struan"],
                       results_exp_6_h3_influence_aware_excluded$logOR[results_exp_6_h3_influence_aware_excluded$var == "Struan"],
                       results_exp_7_h3_influence_aware_excluded$logOR[results_exp_7_h3_influence_aware_excluded$var == "Struan"]),
             logOR_se = c(results_exp_1_h3_influence_aware_excluded$logOR_se[results_exp_1_h3_influence_aware_excluded$var == "Struan"],
                          results_exp_2_h3_influence_aware_excluded$logOR_se[results_exp_2_h3_influence_aware_excluded$var == "Struan"],
                          results_exp_3_h3_influence_aware_excluded$logOR_se[results_exp_3_h3_influence_aware_excluded$var == "Struan"],
                          results_exp_4_h3_influence_aware_excluded$logOR_se[results_exp_4_h3_influence_aware_excluded$var == "Struan"],
                          results_exp_5_h3_influence_aware_excluded$logOR_se[results_exp_5_h3_influence_aware_excluded$var == "Struan"],
                          results_exp_6_h3_influence_aware_excluded$logOR_se[results_exp_6_h3_influence_aware_excluded$var == "Struan"],
                          results_exp_7_h3_influence_aware_excluded$logOR_se[results_exp_7_h3_influence_aware_excluded$var == "Struan"])) %>%
  mutate(yi  = logOR,
         sei = logOR_se) %>%
  # remove exp 2 on the basis of the influence test 
  filter(Experiment != "Experiment 2") %>%
...
mod_meta_results_h3_influence_aware <- 
  moderator_meta_analysis_workflow(data = bind_rows(semi_join(mutate(results_for_meta_analysis_h3_influence_aware, exclude = FALSE),
                                                              results_for_meta_analysis_h3_influence_aware_excluded,
                                                              by = "Experiment"),
                                                    results_for_meta_analysis_h3_influence_aware_excluded),
                                   effect_size_label = "Odds Ratio")
...
forest(mod_meta_results_h3_hypothesis_aware$fitted_model) 
forest(mod_meta_results_h3_influence_aware$fitted_model) 
...
- hypothesis awareness (FALSE were excluded): `r mod_meta_results_h3_hypothesis_aware$mod_meta_analysis_results_text`
- influence awareness (FALSE were excluded): `r mod_meta_results_h3_influence_aware$mod_meta_analysis_results_text`
