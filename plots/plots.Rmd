...
meta_analysis_workflow <- function(data, 
  ...
  fitted_model <- 
    rma(yi = yi, 
        sei = sei,
        data = data,
        slab = str_remove_all(Experiment, "Experiment "))
...
Run this script, then make your viewer pain tall and narrow sized, then open and run open plots_2.R. Save the plot as a 5' by 10' pdf. 