...
results_exp_7_h1 <- data_exp_7 %>%
  mutate(ep_mean_rt_difference = ifelse(source_valence_condition == "CS2_Positive_CS1_Negative", ep_mean_rt_difference*-1, 
                                        ifelse(source_valence_condition == "CS1_Positive_CS2_Negative", ep_mean_rt_difference, NA))) %>%
  select(ep_mean_rt_difference, source_valence_condition) %>%
  na.omit() %>%
  mutate(DV = ep_mean_rt_difference,
         IV = source_valence_condition) %>%
  t_test_analyses(.)
